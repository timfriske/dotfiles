...
Welcome to _My Home My Castle_!

The project _My Home My Castle_ is a personal project of mine.  It
serves me to manage the configuration files of my favorite software I
